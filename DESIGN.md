...
## Mission
Create implementation-ready, token-driven UI guidance for McLaren Formula 1 Driver — Lando Norris that is optimized for consistency, accessibility, and fast delivery across content site.
...
- Color palette: `color.text.primary=#282c20`, `color.text.secondary=#f4f4ed`, `color.text.tertiary=#111112`, `color.surface.muted=#d2ff00`, `color.surface.base=#000000`
...
- Include known page component density: links (37), cards (15), buttons (3).
